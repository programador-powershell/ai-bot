...
export function createStallGuard(options: StallGuardOptions): StallGuard {
  ...
  function watch(
    ...
    return async (url, requestInit) => {
      ...
      // lib do Bun declara no ReadableStreamDefaultReader; o cast só realinha
      // os tipos — em runtime é o mesmo objeto.
      void pump(id, reader as ReadableStreamDefaultReader<Uint8Array>, writer);
